...
// =========== UseState Section ===========
  ...
  // Graph Data 
  const [graph_data_state, set_graph_data_state ] = useState<position_graph_input_interface | null>(null);
...
// =========== Return Section ===========
  return (
    <div className='PL_Main_Div'>
      ...
      <img src={home_page_backgraound} alt="Formula 1 Background" className="PL_Background_Image" />
        ...
        <div className='PL_Combined_Div'>
          ...
          <div className='PL_Control_Div'>
            ...
            <div className='PL_Control_Upper_Div'>
              ...
              <select className='PL_Select_Box' id='Season_Select_Box' 
              ...
              <p className='PL_Select_Title_Span LT_Race'> Races : </p>
              <select className='PL_Select_Box PL_Race_Box' id='Race_Select_Box' 
