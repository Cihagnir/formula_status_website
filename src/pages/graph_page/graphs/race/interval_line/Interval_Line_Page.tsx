...
function Interavl_Line_Page() {
    ...
    const [graph_data_state, set_graph_data_state] =
        useState<interval_graph_input_interface | null>(null);
            ...
            <div className="IL_Window_Div">
                <div className="IL_Combined_Div">
                    <div className="IL_Info_Div">
                        <h3 className="IL_Info_Title">Interval Time</h3>
                        <span className="IL_Info_Text">
                            This line graph shows the intervals as seconds of F1
                            drivers throughout the race. You could use the
                            legend to filter and compare drivers' performance.
                            Also you can change the display style of the
                            intervals with the toggle button .
                        </span>
                    </div>
                    ...
                    <div className="IL_Control_Div">
                        <div className="IL_Control_Upper_Div">
                            ...
                            <p className="IL_Select_Title_Span LT_Race">
                                {" "}
                                Races :{" "}
                            </p>
                            <select
                                className="IL_Select_Box IL_Race_Box"
                                id="Race_Select_Box"
                                onChange={() => {
                            ...
                            >
                                <option className="IL_Select_Option" value={""}>
                                    {" "}
                                    {"Select the Seassion"}{" "}
                                </option>
