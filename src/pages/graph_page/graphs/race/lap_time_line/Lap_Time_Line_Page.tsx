...
function Lap_Time_Line_Page() {
    ...
    const [upper_bound_grpah_state, set_upper_bound_graph_state] =
        useState(1.5);
    const [lower_bound_grpah_state, set_lower_bound_graph_state] =
        useState(1.5);

    // Graph Data
    const [graph_data_state, set_graph_data_state] =
        useState<lap_duration_graph_input_interface | null>(null);
    ...
    useEffect(() => {
        ...
        selected_race_state,
        data_filter_state,
        upper_bound_grpah_state,
        lower_bound_grpah_state,
    ]);
    ...
    return (
        <div className="LTL_Main_Div">
            <img
                ...
                className="LTL_Background_Image"
            />
            ...
            <div className="LTL_Window_Div">
                <div className="LTL_Control_Area_Div">
                    <div className="LTL_Info_Div">
                        <h3 className="LTL_Info_Title">Drivers' Lap Times</h3>

                        <span className="LTL_Info_Text">
                            This line graph shows the lap times of F1 drivers
                            throughout the race. You could use the legend to
                            filter and compare drivers' performance. Also
                            sliders allow you to set custom filtering range.
                        </span>
                    </div>
                    ...
                    <div className="LTL_Control_Div">
                        <div className="LTL_ComboBox_Upper">
                            ...
                            <p className="LTL_Select_Title_Span LT_Race">
                                {" "}
                                Races :{" "}
                            </p>
                            <select
                                className="LTL_Select_Box LTL_Race_Box"
                                id="Race_Select_Box"
                                onChange={() => {
                        ...
                        <div className="LTL_ComboBox_Bottom">
                            <div className="LTL_Info_Hover_Container">
                                ...
                                <div className="LTL_Info_Tooltip">
                                    Use the sliders to change the upper and
                                    lower bounds of the filter.
                                    <br />
                                    <br />
                                    However data come with the filter you
                                    couldn't remove with the sliders. To see the
                                    original data, you could use the button on
                                    far right.
                                </div>
                            </div>
                            ...
                            <div className="LTL_Slider_Group">
                                <label>
                                    Lower Bound : {lower_bound_state.toFixed(2)}
                                </label>
                                <input
                                    type="range"
                                    min="0"
                                    ...
                                    onChange={(e) =>
                                        set_lower_bound_state(
                                            Number(e.currentTarget.value),
                                        )
                                    }
                                    onMouseUp={(e) =>
                                        set_lower_bound_graph_state(
                                            Number(e.currentTarget.value),
                                        )
                                    }
                            ...
                            <div className="LTL_Slider_Group">
                                <label>
                                    Upper Bound : {upper_bound_state.toFixed(2)}
                                </label>
                                <input
                                    type="range"
                                    min="0"
                                    ...
                                    onChange={(e) =>
                                        set_upper_bound_state(
                                            Number(e.currentTarget.value),
                                        )
                                    }
                                    onMouseUp={(e) =>
                                        set_upper_bound_graph_state(
                                            Number(e.currentTarget.value),
                                        )
                                    }
                                    className="LTL_Range_Slider"
