...
import {
    BASE_URL,
    lap_dstrb_graph_data_interface,
} from "../../../Commen_Utils";
...
function Lap_Time_Distr_Page() {
    ...
    const [graph_data_state, set_graph_data_state] =
        useState<Array<lap_dstrb_graph_data_interface> | null>(null);
    ...
    return (
        <div className="LTD_Main_Div">
            <img
                ...
                className="LTD_Background_Image"
            />
            ...
            <div className="LTD_Window_Div">
                <div className="LTD_Combined_Container">
                    <div className="LTD_Info_Div">
                        ...
                        <span className="LTD_Info_Text">
                            Explore lap time distribution for each races. The
                            graph reveals drivers' consistency, pace variations,
                            and outliers, helping you analyze performance trends
                            and key race moments. Dive in and see the story
                            behind the numbers !
                        </span>
                    </div>
                    ...
                    <div className="LTD_ComboBox_Div">
                        ...
                        <p className="LTD_Select_Title_Span LTD_Race">
                            {" "}
                            Races :{" "}
                        </p>

                        <select
                            className="LTD_Select_Box LTD_Race_Box"
                            id="Race_Select_Box"
                            onChange={() => {
                ...
                {graph_data_state !== null ? (
                    <Lap_Time_Graph graph_data={graph_data_state} />
                ) : null}
            </div>
        </div>
    );
