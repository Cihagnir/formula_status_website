...
// ======== UseState Section ========
  ...
  const [selected_first_driver_state, set_selected_first_driver_state] = useState<string>('');
  const [selected_first_session_state, set_selected_first_session_state] = useState<string>('')
  const [selected_second_driver_state, set_selected_second_driver_state] = useState<string>('');
  const [selected_second_session_state, set_selected_second_session_state] = useState<string>('')

  // Graph Data 
  const [graph_data_state, set_graph_data_state ] = useState< quali_lap_compre_graph_input_interface | null>( null  ) ;

  // Dropdown Box Datas
  const [seassion_array_state, set_seassion_array_state] =useState( [] );
  const [session_info_json_state, set_session_info_json_state] = useState<{ [keys : string] : Array<string> }>( {} );
  const [race_name_array_state, set_race_name_array_state] = useState( ['Select the Race'] ) ;
...
// ======== UseEffect Section ========
  ...
  useEffect( () => {
    ...
    if ((! (selected_first_driver_state === '') && ( ! (selected_second_driver_state === ''))) ) {
...
const race_change_handler = () => {
  set_selected_race_state((document.getElementById("Race_Select_Box") as HTMLInputElement).value);
  ...
  (document.getElementById("Session_Select_Box_One") as HTMLSelectElement).value = '';
  (document.getElementById("Driver_Select_Box_One") as HTMLSelectElement).value = '';
  ...
  (document.getElementById("Session_Select_Box_Two") as HTMLSelectElement).value = '';
  (document.getElementById("Driver_Select_Box_Two") as HTMLSelectElement).value = '';
};
...
// ======== Return Section ========
  ...
  return (
    <div className='LTC_Main_Div'>
      ...
      <img src={home_page_backgraound} alt="Formula 1 Background" className="LTC_Background_Image" />
      ...
      <div className='LTC_Window_Div'>
        ...
        <div className='LTC_Combined_Div'>
          ...
          <div className='LTC_Combined_Upper_Div'>
            ...
            Basic comparison between the driver qualification laps, 
            provide us more understanding about car's limits and characteristics.
            You could select the any two driver's laps you want from the 
          ...
          <div className='LTC_Combined_Middle_Div'>
            ...
            <select className='LTC_Select_Box' id='Season_Select_Box' 
            ...
            <p className='LTC_Select_Title_Span LTC_Race'> Qualification : </p>
            <select className='LTC_Select_Box LTC_Race_Box' id='Race_Select_Box' 
              onChange= { race_change_handler } >
              <option value={''} > {'Select the Seassion'} </option> ;
              {
                race_name_array_state.map(
                  (track_name, index) => (
                    <option value={track_name} > {track_name} </option>
                  ) 
                )
          ...
          <div className='LTC_Combined_Bottom_Div'>
            ...
            <div className='LTC_Combined_Bottom_First_Lap_Div'>
              ...
              <select className='LTC_Select_Box LTC_Select_Bottom' id='Session_Select_Box_One' 
                onChange={ () => set_selected_first_session_state( (document.getElementById('Session_Select_Box_One') as HTMLInputElement).value ) }>
              ...
              <select className='LTC_Select_Box LTC_Select_Bottom' id='Driver_Select_Box_One' 
                onChange={ () => set_selected_first_driver_state( (document.getElementById('Driver_Select_Box_One') as HTMLInputElement).value ) } >
                <option value={''}> Driver </option>
                
                { (session_info_json_state[selected_first_session_state]) &&
                  (session_info_json_state[selected_first_session_state].map(
                    ( driver_name, index ) => (
            ...
            <div className='LTC_Combined_Bottom_Second_Lap_Div' >
              ...
              <select className='LTC_Select_Box LTC_Select_Bottom' id='Session_Select_Box_Two' 
                onChange={ () => set_selected_second_session_state( (document.getElementById('Session_Select_Box_Two') as HTMLInputElement).value ) }>
                <option value={''} > Session  </option>
              ...
              <select className='LTC_Select_Box LTC_Select_Bottom' id='Driver_Select_Box_Two' 
                onChange={ () => set_selected_second_driver_state( (document.getElementById('Driver_Select_Box_Two') as HTMLInputElement).value ) } > 
                <option value='' > Driver </option>

                {(session_info_json_state[selected_second_session_state]) &&
                  (session_info_json_state[selected_second_session_state].map(
                    ( driver_name, index ) => (
                      <option value= {driver_name} > {driver_name} </option>
                    )
                  ))
        ...
        {
          (graph_data_state !== null) ? (<Lap_Compare_Graph graph_data={graph_data_state.graph_data} graph_info={graph_data_state.graph_info}/>) : (null)
        }
